...
export default function Hero({
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center -mt-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Button
            size="lg"
            variant="default"
            className="gap-2 text-base px-8 opacity-70 transition-all duration-300 hover:bg-primary/20 hover:shadow-[0_0_20px_rgba(0,188,212,0.6)] hover:border-transparent focus-visible:ring-0"
            onClick={() => {
      ...
      <div className="absolute bottom-[57px] left-[calc(44.5%+10px)] -translate-x-1/2 z-10 animate-bounce -mt-20">
        <svg
          width="26"
          height="26"
          viewBox="0 0 40 40"
