        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto mb-16">
            ...
            <p className="text-foreground/70 text-lg leading-relaxed mb-6">
              Paint correction is the most visually impactful exterior enhancement a detailer can make
              to a vehicle's exterior. If you want to enhance the gloss of your car's paint or remove
              unsightly swirls and scratches, then this is achievable with our paint correction and
              enhancement (machine polishing) services.
            </p>
            <p className="text-foreground/70 text-lg leading-relaxed">
              We use different grades of abrasive polishes and pads along with our modern-day polishing
              techniques and equipment to achieve the best finish possible from the packages we offer
              below.
            </p>
          </div>
