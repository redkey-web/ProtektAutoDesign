...
export default function QuoteCalculator() {
  ...
  const handleRequestQuote = () => {
    // TODO: Replace with actual form submission in Phase B
    // Could pass selectedServices and vehicleSize to a form
    ...
    <Card className="w-full max-w-3xl mx-auto" data-testid="quote-calculator">
      ...
      <CardContent className="space-y-6">
        <div className="space-y-3">
          ...
          <RadioGroup
            value={vehicleSize}
            onValueChange={(value) => setVehicleSize(value as VehicleSize)}
